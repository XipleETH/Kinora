...
export const WeekVideo: React.FC<WeekVideoProps> = ({ frames, fps = 12, autoPlay = true, loop = true, title }) => {
  ...
  <div className="relative aspect-[9/16] bg-black/40 rounded-2xl overflow-hidden border border-white/20 flex items-center justify-center w-[250px] sm:w-[250px] md:w-[270px] lg:w-[300px] xl:w-[340px] transition-shadow shadow-[0_0_0_0_rgba(255,255,255,0.1)] hover:shadow-[0_0_0_3px_rgba(255,255,255,0.15)]">
